    ...
    return (
        <div style={{ maxWidth: "1300px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "28px" }}>
            ...
            <div>
                ...
                <p style={{ color: "#64748b", marginTop: "6px", fontSize: "0.88rem" }}>AI-driven analysis comparing what we teach vs what the industry demands.</p>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
                {/* Radar */}
                <div style={CARD}>
                    <h3 style={{ fontWeight: 800, color: "white", fontSize: "0.95rem", margin: "0 0 4px" }}>🕸 Curriculum vs Industry Skills Radar</h3>
                    <p style={{ fontSize: "0.75rem", color: "#64748b", margin: "0 0 16px" }}>Skill-by-skill comparison of current curriculum vs market demand</p>
                ...
                {/* Skill gap bar */}
                <div style={CARD}>
                    <h3 style={{ fontWeight: 800, color: "white", fontSize: "0.95rem", margin: "0 0 4px" }}>📊 Skill Demand vs Readiness</h3>
                    <p style={{ fontSize: "0.75rem", color: "#64748b", margin: "0 0 16px" }}>Industry demand vs current student skill readiness per subject</p>
                    <ResponsiveContainer width="100%" height={280}>
            ...
            {/* AI Recommendations */}
            <div style={CARD}>
                <h3 style={{ fontWeight: 800, color: "white", fontSize: "0.95rem", margin: "0 0 6px", display: "flex", alignItems: "center", gap: "8px" }}>
                    <Lightbulb size={17} color="#f59e0b" /> AI Curriculum Recommendations
                </h3>
                <p style={{ fontSize: "0.8rem", color: "#64748b", margin: "0 0 18px" }}>Auto-generated improvement plan based on industry trend analysis</p>
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                    {AI_RECOMMENDATIONS.map((r, i) => (
                        <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "14px", padding: "14px 16px", background: `${TAG_COLOR[r.type]}08`, border: `1px solid ${TAG_COLOR[r.type]}20`, borderRadius: "12px" }}>
                            ...
                            <p style={{ flex: 1, fontSize: "0.85rem", color: "#cbd5e1", lineHeight: 1.55, margin: 0 }}>{r.text}</p>
            ...
            {/* Outdated subjects */}
            <div style={CARD}>
                <h3 style={{ fontWeight: 800, color: "white", fontSize: "0.95rem", margin: "0 0 16px" }}>⚠ Subjects Flagged as Outdated / Low Industry Relevance</h3>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "12px" }}>
                    {[
                        ...
                        <div key={s.name} style={{ padding: "14px 16px", background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: "12px" }}>
                            <div style={{ fontWeight: 700, color: "white", fontSize: "0.88rem", marginBottom: "8px" }}>{s.name}</div>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                <div style={{ fontSize: "0.75rem", color: "#64748b" }}>Relevance: <span style={{ color: "#ef4444", fontWeight: 700 }}>{s.relevance}/100</span></div>
