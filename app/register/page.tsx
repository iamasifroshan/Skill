    ...
    return (
        <div className="login-page">
            ...
            <style jsx>{`
                ...
                .login-field input:focus { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1); }
                .login-submit { width: 100%; margin-top: 6px; background: #3b82f6; color: #ffffff; border: none; border-radius: 10px; padding: 14px; font-size: 0.95rem; font-weight: 800; display: flex; align-items: center; justify-content: center; gap: 8px; cursor: pointer; transition: all 0.25s; }
                .login-submit:hover { background: #2563eb; color: #ffffff; box-shadow: 0 0 0 2px #3b82f6; transform: translateY(-1px); }
